...
local style_file = io.open(state_home .. "/nixrice/style", "r")
M.cyberpunk = style_file and style_file:read("*l") == "cyberpunk" or false
if style_file then style_file:close() end
